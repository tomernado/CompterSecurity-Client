...
const useStyles = makeStyles({
    ...
    title: {
        ...
        marginBottom: '10px', textAlign: 'center', fontFamily: "'Poppins', sans-serif",
    },
    subtitle: {
        fontSize: '0.95rem', color: '#08155a', marginBottom: '20px', textAlign: 'center'
    },
    formContainer: {
        display: 'flex', flexDirection: 'column', gap: '15px', width: '90%', marginBottom: '35px',
    },
    buttonsContainer: {
        display: 'flex', flexDirection: 'column', gap: '10px', width: '70%',
    }
});
