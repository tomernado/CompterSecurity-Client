...
const useStyles = makeStyles({
    ...
    title: { 
        fontSize: '2.2rem', color: '#08155a', fontWeight: 'bold', fontFamily: "'Poppins', sans-serif", marginBottom: '5px' 
    },

    subtitle: { 
        color: '#273573ff', marginBottom: '40px', fontSize: '1.1rem', fontWeight: '500' 
    },

    buttons: { 
        display: 'flex', flexDirection: 'column', gap: '20px', width: '60%' 
    },

    actionButton: { 
     height: '50px', fontWeight: 'bold', boxShadow: '0 4px 10px rgba(0,0,0,0.8)'
    }
});
            ...
            <div className={classes.centerProfile}>
                ...
                <div className={classes.buttons}>
                    <Button variant="contained" color="primary" className={classes.actionButton}
                         startIcon={<VpnKeyIcon />} onClick={() => navigate('/ChangePassword')}>
                         CHANGE PASSWORD
                    </Button>

                    <Button variant="contained" color="error" 
                    className={classes.actionButton} startIcon={<LogoutIcon />}
                         onClick={() => navigate('/')}>
                         LOGOUT
                    </Button>
                </div>
